...
l_style <- l_style[, -1] # remove first column
...
# if no hoverlabel = h, the bgcolor of hoverlabel = color of Category
...
d_plot3 <- d_plot3 %>%
  ...
  summarise(Total = n())
d_plot3 <- complete(d_plot3, Rated.for, fill = list(Total = 0))
